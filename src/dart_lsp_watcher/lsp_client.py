"""LSP client for communicating with Dart language server."""
...
from dart_lsp_watcher.utils.uri import normalize_uri, path_to_uri, uri_to_path
...
class LspClient:
    ...
    def start(self) -> bool:
        ...
        try:
            ...
            print(f"{COLORS.RED}Error: dart not found.{COLORS.RESET}", file=sys.stderr)
            print("Please install the Dart SDK: https://dart.dev/get-dart", file=sys.stderr)
            return False
