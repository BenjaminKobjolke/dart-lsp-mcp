"""Library API for programmatic access to Dart LSP diagnostics."""
...
@dataclass
class Diagnostic:
    """Represents a single diagnostic from Dart language server."""
...
def get_diagnostics(
    ...
    """Get Dart diagnostics for a project.

    This function creates an LSP client, indexes all Dart files in the project,
    ...
    Args:
        ...
        ignore_patterns: List of glob patterns to ignore (e.g., ["build/**", ".dart_tool/**"]).
